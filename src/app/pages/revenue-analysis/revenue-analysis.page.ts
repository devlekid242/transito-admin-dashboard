...
export class RevenueAnalysisPage {
	...
	readonly loading = computed(() =>
		this.financialService.loadingRevenueAnalysis(),
	);
	readonly error = computed(() =>
		this.financialService.errorRevenueAnalysis(),
	);
	...
	readonly refundsTrendLabels = computed(
		() => this.data()?.refundsTrend.labels ?? [],
	);
