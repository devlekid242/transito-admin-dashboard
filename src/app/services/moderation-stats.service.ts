...
export class ModerationStatsService {
  ...
  readonly agencyStats = computed(() => this.moderationStats()?.agencies ?? null);
  readonly reservationStats = computed(() => this.moderationStats()?.reservations ?? null);
  readonly financeStats = computed(() => this.moderationStats()?.finance ?? null);
  readonly agencyComparison = computed(() => this.moderationStats()?.comparison ?? []);
  ...
  loadStats() {
    ...
    return this.http
      .get<ApiResponse<ModerationStats>>(`${this.apiBaseUrl}/admin/moderation/stats`, { params })
      .pipe(
        tap(response => {
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des statistiques' });
        }),
  ...
  loadDatePresets() {
    ...
    return this.http
      .get<ApiResponse<DatePreset[]>>(`${this.apiBaseUrl}/admin/moderation/date-presets`)
      .pipe(
        tap(response => {
          if (response.success && response.data) {
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des préréglages de date' });
        }),
  ...
  loadAgencies() {
    ...
    return this.http
      .get<ApiResponse<AgencyFilterItem[]>>(`${this.apiBaseUrl}/admin/moderation/agencies`)
      .pipe(
        tap(response => {
          if (response.success && response.data) {
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des agences' });
        }),
  ...
  loadChartData(chartType: string) {
    ...
    return this.http
      .get<ApiResponse<ChartData>>(`${this.apiBaseUrl}/admin/moderation/charts/${chartType}`, { params })
      .pipe(
        tap(response => {
          if (response.success && response.data) {
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || `Erreur lors du chargement du graphique ${chartType}` });
        }),
    ...
    return this.http
      ...
      .pipe(
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des graphiques' });
        }),
        tap(() => this.loadingCharts.set(false))
      );
  }
    ...
    return this.http
      ...
      .pipe(
        ...
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des comparaisons' });
        }),
  ...
  loadLeaderboard(metric: string = 'reservations', limit: number = 10) {
    ...
    return this.http
      .get<ApiResponse<{ data: AgencyComparison[], metric: string }>>(`${this.apiBaseUrl}/admin/moderation/leaderboard`, { params })
      .pipe(
        tap(response => {
          if (response.success && response.data) {
            const data = response.data;
        ...
        catchError(error => {
          console.error(`Error loading leaderboard by ${metric}:`, error);
          return of({ success: false, message: error.error?.message || `Erreur lors du chargement du classement par ${metric}` });
        }),
        tap(() => this.loadingComparison.set(false))
      );
  }
    ...
    return this.http
      ...
      .pipe(
          ...
          if (response.success && response.data) {
            ...
            this.moderationStats.update(current => {
              ...
              return {
                ...
                agencies: { ...current.agencies, ...data.agencies },
                reservations: { ...current.reservations, ...data.reservations },
                finance: { ...current.finance, ...data.finance }
              };
            });
          }
        }),
        catchError(error => {
          ...
          return of({ success: false, message: error.error?.message || 'Erreur lors du chargement des KPI' });
        }),
        tap(() => this.loadingStats.set(false))
      );
  }
